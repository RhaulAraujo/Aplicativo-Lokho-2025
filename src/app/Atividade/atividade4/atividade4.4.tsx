...
export default function atv3_soletrando() {
   ...
   const Pressionar_barra1 = () => {
    if (progresso1 < 4) {
      ...
      AsyncStorage.setItem('progress1', String(progresso1 + 1)); 
    }
  };
  ...
  <View style={styles.containeractiv}>
            ...
            >
           <Image style={styles.box1} source={require('@/assets/images/ativ-2/Desculpe_frase.jpeg')} resizeMode='contain'/>
            </TouchableOpacity>
            ...
            >
           <Image style={styles.box1} source={require('@/assets/images/ativ-2/oi-tchau_gesto.jpeg')} resizeMode='contain'/>
            </TouchableOpacity>   
        ...
        <View style={styles.containeractiv}>
            ...
            >
           <Image style={styles.box2} source={require('@/assets/images/ativ-2/Desculpe_gesto.jpeg')} resizeMode='contain'/>
            </TouchableOpacity>   
        </View>
        ...
        <View style={styles.containeractiv}>
            ...
            >
           <Image style={styles.box2} source={require('@/assets/images/ativ-2/Tudo bem_gesto.jpeg')} resizeMode='contain'/>
            </TouchableOpacity>   
        </View>
