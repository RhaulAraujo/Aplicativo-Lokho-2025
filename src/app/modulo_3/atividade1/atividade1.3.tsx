...
export default function atv1_cores_2() {
  ...
  <ThemedView style={styles.BlocoFundo}>
      ...
      <View style={styles.containeractiv}>
          ...
          >
         <Image style={styles.box1} source={require('@/assets/images/ativ-6/Laranja_cor.jpeg')} resizeMode='contain'/>
          </TouchableOpacity>
          ...
          >
         <Image style={styles.box1} source={require('@/assets/images/ativ-6/Verde_sinal.jpeg')} resizeMode='contain'/>
          </TouchableOpacity>   
      ...
      <View style={styles.containeractiv}>
          ...
          >
         <Image style={styles.box2} source={require('@/assets/images/ativ-6/Laranja_sinal.jpeg')} resizeMode='contain'/>
          </TouchableOpacity>   
      </View>
      ...
      <View style={styles.containeractiv}>
          ...
          onPress={() => handleSelect('B')}
          >
         <Image style={styles.box2} source={require('@/assets/images/ativ-6/Amarelo_sinal.jpeg')} resizeMode='contain'/>
          </TouchableOpacity>   
      </View>
          ...
          onPress={() => handleSelect('B')}
          >
         <Image style={styles.box2} source={require('@/assets/images/ativ-6/Azul_sinal.jpeg')} resizeMode='contain'/>
          </TouchableOpacity>   
      </View>
