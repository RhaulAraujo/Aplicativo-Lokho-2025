...
export default function atv1_animais_2() {
 ...
 <ThemedView style={styles.BlocoFundo}>
      ...
      <View style={styles.containeractiv}>
          ...
          >
         <Image style={styles.box1} source={require('@/assets/images/ativ-7/Urubu.jpeg')} resizeMode='contain'/>
          </TouchableOpacity>
          ...
          >
         <Image style={styles.box1} source={require('@/assets/images/ativ-7/Veado_sinal.jpeg')} resizeMode='contain'/>
          </TouchableOpacity>   
      ...
      <View style={styles.containeractiv}>
          ...
          onPress={() => handleSelect('B')}
          >
         <Image style={styles.box2} source={require('@/assets/images/ativ-7/Panda_sinal.jpeg')} resizeMode='contain'/>
          </TouchableOpacity>   
      </View>
      ...
      <View style={styles.containeractiv}>
          ...
          >
         <Image style={styles.box2} source={require('@/assets/images/ativ-7/Urubu_sinal.jpeg')} resizeMode='contain'/>
          </TouchableOpacity>   
      </View>
          ...
          onPress={() => handleSelect('B')}
          >
         <Image style={styles.box2} source={require('@/assets/images/ativ-7/Zebra_sinal.jpeg')} resizeMode='contain'/>
          </TouchableOpacity>   
      </View>
