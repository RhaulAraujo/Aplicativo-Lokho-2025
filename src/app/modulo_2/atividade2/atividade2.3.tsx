...
export default function Atv_numeros_soma() {
...
const checkAnswer = () => {
  ...
  return (
    <ScrollView style={styles.container}>
     ...
     <Text style={styles.titu_tex}>Calcule a soma e selecione o resultado:</Text>
      ...
      <View style={styles.containeractiv}>
          ...
          >
         <Image style={styles.box1} source={require('@/assets/images/algarismas/9.jpeg')} resizeMode='contain'/>
          </TouchableOpacity>   
      ...
      <View style={styles.containeractiv}>
          ...
          onPress={() => handleSelect('B')}
          >
         <Image style={styles.box2} source={require('@/assets/images/algarismas/5.jpeg')} resizeMode='contain'/>
          </TouchableOpacity>   
      </View>
          ...
          onPress={() => handleSelect('B')}
          >
         <Image style={styles.box2} source={require('@/assets/images/algarismas/1.jpeg')} resizeMode='contain'/>
          </TouchableOpacity>   
      </View>
